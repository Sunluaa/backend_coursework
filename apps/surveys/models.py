...
class Survey(models.Model):
    ...
    allow_anonymous = models.BooleanField("Разрешить гостевые ответы", default=False)
    allow_multiple_submissions = models.BooleanField("Разрешить повторные прохождения", default=False)
